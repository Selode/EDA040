...
public class ClockOutput {
	...
	/**
	 * If the display is currently used to display the time, update it. If user
	 * is using display for setting clock or alarm time, do nothing when with
	 * actual hardware or show info when simulating.
	 */
